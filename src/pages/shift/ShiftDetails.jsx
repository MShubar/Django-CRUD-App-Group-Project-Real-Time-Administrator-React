      ...
      <>
        ...
        <div className="card p-4">
          ...
          <div className="d-flex justify-content-between mt-3">
            <button onClick={() => navigate(`/updateshift/${shift._id}`)} className="btn btn-warning btn-sm">
              Edit
            </button>

            <button onClick={() => navigate(`/deleteshift/${shift._id}`)} className="btn btn-danger btn-sm">
              Delete
            </button>

            <button onClick={() => navigate('/shift')} className="btn btn-secondary btn-sm">
              Back to List
            </button>
          </div>
        </div>
